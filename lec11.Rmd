...
(x + y) f(x,y)\,dx\,dy\\
\onslide<2->{&= \int\limits_{-\infty}^{\infty}\int\limits_{-\infty}^{\infty} x f(x,y)\,dy\,dx + \int\limits_{-\infty}^{\infty}\int\limits_{-\infty}^{\infty} y f(x,y)\,dx\,dy\\}
\onslide<3->{&= \int\limits_{-\infty}^{\infty} x \int\limits_{-\infty}^{\infty}  f(x,y)\,dy\,dx + \int\limits_{-\infty}^{\infty} y \int\limits_{-\infty}^{\infty}  f(x,y)\,dx\,dy\\}
